...
export class PantallaVendedorComponent implements OnInit {
  public productosVendedor: Producto[] = [];
  ...
  public nuevoPrecio: string;
  public nuevaDescripcion: string;

  public addNombre: string = "";
  public addPrecio: string = "";
  public addDescripcion: string = "";
  public idNuevoProducto: string = "";
  ...
  actualizar(producto: Producto, accion) {
    ...
    this.productoService
      .updateProducto(producto.id, this.nuevoNombre, this.nuevoPrecio, this.nuevaDescripcion)
      .subscribe(retObs => {}, error => {});
  }

  crearProducto() {
    if (this.idNuevoProducto === "") {
      this.productoService
        .addProducto(this.addNombre, this.addPrecio, this.addDescripcion, "Poli", +sessionStorage.getItem("seller"))
        .subscribe(
          retObs => {
      ...
      this.productoService
        .updateProducto(+this.idNuevoProducto, this.addNombre, this.addPrecio, this.addDescripcion)
        .subscribe(retObs => {}, error => {});
    }
  }
  ...
  onUpload(event) {
    ...
    for (let file of event.files) {
      ...
      switch (cont) {
        case 1:
          nombreImagenProducto = "p1";
          break;
        case 2:
          nombreImagenProducto = "p2";
          break;
        case 3:
          nombreImagenProducto = "p3";
          break;
        case 4:
          nombreImagenProducto = "p4";
          break;
        case 5:
          nombreImagenProducto = "p5";
          break;
      }

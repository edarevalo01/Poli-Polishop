...
export class PantallaProductoComponent implements OnInit {
	...
	cargarProducto(retid) {
		this.productoService.getAllProductoById(retid).subscribe(
			...
			() => {
				...
				var filess = (this.productoTmp.nombre + "guid" + this.productoTmp.nombreVendedor)
					.replace(/[^A-Z0-9]/gi, "")
					.toLowerCase();
				this.imgs = ["p1.png", "p2.png", "p3.png", "p4.png", "p5.png"];
				this.images.push({ source: this.productoTmp.urlCarpetaImagenes + "/p1.png", title: this.productoTmp.nombre });
				this.images.push({ source: this.productoTmp.urlCarpetaImagenes + "/p2.png", title: this.productoTmp.nombre });
				this.images.push({ source: this.productoTmp.urlCarpetaImagenes + "/p3.png", title: this.productoTmp.nombre });
				this.images.push({ source: this.productoTmp.urlCarpetaImagenes + "/p4.png", title: this.productoTmp.nombre });
				this.images.push({ source: this.productoTmp.urlCarpetaImagenes + "/p5.png", title: this.productoTmp.nombre });
			}
		);
	}
	...
	setImgCalificacionProducto(calificacionProducto: number) {
		switch (calificacionProducto) {
			case 0:
				this.imgCalificacionProducto = "assets/system/calificacionCero.png";
				break;
			case 1:
				this.imgCalificacionProducto = "assets/system/calificacionUno.png";
				break;
			case 2:
				this.imgCalificacionProducto = "assets/system/calificacionDos.png";
				break;
			case 3:
				this.imgCalificacionProducto = "assets/system/calificacionTres.png";
				break;
			case 4:
				this.imgCalificacionProducto = "assets/system/calificacionCuatro.png";
				break;
			case 5:
				this.imgCalificacionProducto = "assets/system/calificacionCinco.png";
				break;
		}
	}
	...
	setImgCalificacionVendedor(calificacionVendedor: number) {
		switch (calificacionVendedor) {
			case 0:
				this.imgCalificacionVendedor = "assets/system/calificacionCero.png";
				break;
			case 1:
				this.imgCalificacionVendedor = "assets/system/calificacionUno.png";
				break;
			case 2:
				this.imgCalificacionVendedor = "assets/system/calificacionDos.png";
				break;
			case 3:
				this.imgCalificacionVendedor = "assets/system/calificacionTres.png";
				break;
			case 4:
				this.imgCalificacionVendedor = "assets/system/calificacionCuatro.png";
				break;
			case 5:
				this.imgCalificacionVendedor = "assets/system/calificacionCinco.png";
				break;
		}
	}
